...
VALUES
  ('00000000-0000-4000-9000-000000000201', 'ANXIETY_SYMPTOMS', 'PRIMARY', 'GAD_7', ARRAY['MINIMAL','MILD'], ARRAY['SELF_GUIDED_SUPPORT']),
  ...
  ('00000000-0000-4000-9000-000000000205', 'DEPRESSIVE_SYMPTOMS', 'PRIMARY', 'PHQ_9', ARRAY['MINIMAL','MILD'], ARRAY['SELF_GUIDED_SUPPORT']),
  ('00000000-0000-4000-9000-000000000206', 'ANXIETY_SYMPTOMS', 'PRIMARY', 'GAD_7', ARRAY['MINIMAL','MILD'], ARRAY['SELF_GUIDED_SUPPORT']),
  ...
  ('00000000-0000-4000-9000-000000000208', 'DEPRESSIVE_SYMPTOMS', 'PRIMARY', 'PHQ_9', ARRAY['MINIMAL','MILD'], ARRAY['SELF_GUIDED_SUPPORT']),

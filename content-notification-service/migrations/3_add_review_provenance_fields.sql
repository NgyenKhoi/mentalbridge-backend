...
-- Story:     MB-251 - Approve resource review provenance and transition contract
...
COMMENT ON COLUMN resource.reviewed_by IS 
  'Admin user ID who approved publication. Required for PUBLISHED status. Immutable after publish.';

COMMENT ON COLUMN resource.reviewed_at IS 
  'Timestamp when resource was reviewed and approved. Required for PUBLISHED status. Immutable after publish.';

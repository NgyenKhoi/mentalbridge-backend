...
assert.match(notificationInbox, /uq_notification_recipient_source_identity/);
assert.match(notificationInbox, /ON notification \(recipient_id, source, source_identity\)/);

...
| 15–19, 25–27 | journal CRUD, AI Companion analysis/result/re-run | Journal/AI Service (Node.js) | Exact-revision request, current Care consent, MongoDB durable job/lease, one provider per run, normalized MongoDB result; no PostgreSQL or Kafka in MB-367 |

...
MongoDB stores variable, write-heavy content where document access follows an aggregate. PostgreSQL remains authoritative for identity, consent, scoring, risk, appointments, job state, and audit.

...
| Care profile and consent | `IMPLEMENTED — VERIFIED` | Own-profile optimistic concurrency, backend-owned `privacy-capstone-v2`, and append-only grant/revoke decisions pass the Care PostgreSQL integration suite. |

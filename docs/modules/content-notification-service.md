...
Sprint 1 covers CN-01, resource/hotline OpenAPI and owner `node-pg-migrate` baseline, and a reviewed resource/hotline CRUD slice with synthetic data. Notification preferences/history, Kafka consumers, templates, Brevo/push delivery, retry/dead-letter handling, and live delivery are deferred. No provider or cloud account is needed.

...
| UC-02 Mental Health Assessment & AI Analysis | Care/Journal-AI | Content/Notification; optional future PhoBERT baseline | Journal, two-domain assessment, AI Companion analysis and conversation, cross-cutting safety/support and personal analytics | Journal CRUD, screening, exact/longitudinal analysis, and quota-governed AI Companion chat runtimes exist; real provider activation remains approval-gated; no global severity; PhoBERT remains deferred |
| UC-03 Intervention & Support | Care/Content-Notification | Journal/AI | All-tier Support Guide, paid single official SupportPlan, reviewed eligibility/directory, safety guidance and notifications | Coarse v1 routing and Resource Eligibility v1 exist; scope v2 guide/plan/change-request runtime remains gated |
| UC-04 Specialist Discovery & Appointment | Consultation/Billing | Care, Journal/AI, Realtime, Content/Notification | Discovery, VND/MoMo purchase/upgrade/credits, specialist approval, chat/video appointment, brief/summary/next steps, earnings, reviews | ADR 0017 amends the flow; compatible video/evidence/contracts/persistence/frontend remain unimplemented |
| UC-05 Communication & Follow-up | Realtime/Care | Consultation, Content/Notification | Chat, reports, at-most-daily digest, opt-in resource reminders, one-time appointment reminder, follow-up and progress | Scope v2 reminder policy approved; runtime and moderation/retention remain gated |
...
| 42-51, 108-110, 123-129 | Consultation/Billing | `FREE`/`PLUS`/`PREMIUM`, VND/MoMo purchase, `PLUS`-to-`PREMIUM` upgrade, credits, 70%-of-allocation earnings and payout history under ADR 0017 |
...
3. Reviewed Vietnamese safety/disclaimer wording, exact directory sources and
   ...
   geolocation, automatic contact, or after-hours safety service is planned.
...
7. Scope v2 fixes 60-minute chat/video modes and requires `SESSION_ENDED`
   before separate evidence-backed completion. Video signaling/provider,
   authorization, presence evidence, recording prohibition, and failure
   handling remain open contract/delivery work.
...
11. Exact MoMo request type/payment methods, credential/key rotation,
    settlement delay, chargeback reconciliation, payout onboarding, VND prices,

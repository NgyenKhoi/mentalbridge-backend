...
| [SupportPlan policy v2](support-plan-policy-v2.md) | `MB-SCOPE-V2-001` | Draft, admitted choices, activation, and current query implemented by MB-372/MB-373 | Distinguishes the all-tier Support Guide from the `PLUS`/`PREMIUM` durable plan and governs specialist `PlanChangeRequest` input |

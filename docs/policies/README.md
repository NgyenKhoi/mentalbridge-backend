...
| [Care support routing and SupportPlan](care-support-and-intervention-policy.md) | `1.2-support-plan-policy-freeze` | Controlled Capstone v1 routing published; SupportPlan product policy approved; runtime unavailable | `mb-support-routing-capstone-v1` remains immutable coarse routing; #49 is the policy gate, while #48/#50 providers and later proposal/lifecycle runtime retain separate gates |

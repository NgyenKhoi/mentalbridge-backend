...
| [SupportPlan policy v2](support-plan-policy-v2.md) | `MB-SCOPE-V2-001` | Draft, activation, scheduling, explicit lifecycle, and immutable terminal history implemented through MB-374/MB-513 | Distinguishes the all-tier Support Guide from the `PLUS`/`PREMIUM` durable plan and keeps lifecycle changes user-confirmed and Care-owned |

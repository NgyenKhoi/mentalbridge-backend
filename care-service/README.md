...
| `reassessment_summary` | Immutable owner-scoped four-dimension snapshot with request idempotency, exact periods, external Journal/AI analysis provenance, and explicit unavailable/insufficient states |
